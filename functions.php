...
require_once get_stylesheet_directory() . '/inc/limo-landing-page.php';
require_once get_stylesheet_directory() . '/inc/limo-landing-images-admin.php';
require_once get_stylesheet_directory() . '/inc/annam-limo-landing-schema.php';
require_once get_stylesheet_directory() . '/inc/tour-sapa-landing-page.php';
require_once get_stylesheet_directory() . '/inc/tour-sapa-landing-images-admin.php';
require_once get_stylesheet_directory() . '/inc/annam-tour-sapa-landing-schema.php';
